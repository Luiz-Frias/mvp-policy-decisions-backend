...
from policy_core.api.dependencies import get_current_user
from policy_core.api.response_patterns import (
    APIResponseHandler,
    ErrorResponse,
    handle_result,
)
from policy_core.core.result_types import Result
from policy_core.schemas.quote import QuoteCreateRequest, QuoteResponse
from policy_core.schemas.responses import (
    CreatedResponse,
    CreatedResult,
    DeletedResponse,
    DeletedResult,
...
async def create_quote(
    ...
    from policy_core.core.result_types import Ok
...
async def get_quote(
    ...
    # Mock service call for example
    from policy_core.core.result_types import Err, Ok
...
1. ✅ Import required types:
   ...
   - from policy_core.api.response_patterns import handle_result, ErrorResponse
   - from typing import Union
