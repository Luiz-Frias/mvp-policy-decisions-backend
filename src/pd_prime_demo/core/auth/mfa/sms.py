...
class SMSProvider:
    ...
    async def send_verification_code(
        ...
        try:
            ...
            verification = SMSVerification(
                ...
                carrier_verified=sim_swap_check.value.get("carrier_verified", False),
            )
    ...
    async def verify_code(self, verification_id: str, code: str, user_id: str) -> Result[bool, str]:
        ...
        try:
            ...
            verification_data = await self._cache.get(cache_key)
            ...
            if not hmac.compare_digest(code_hash, verification_data["code_hash"]):
                ...
                remaining = self._max_attempts - verification_data["attempts"]
    ...
    async def _check_sim_swap_risk(self, phone_number: str) -> Result[dict[str, Any], str]:
        ...
        try:
            ...
            risk_indicators = {
                ...
                "risk_score": 0.1,  # 0-1 scale
            }

            # Check if SIM was recently swapped
            if risk_indicators["days_since_activation"] < 1:
                risk_indicators["sim_swap_safe"] = False
                risk_indicators["risk_score"] = 0.9
