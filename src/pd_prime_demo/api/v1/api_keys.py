...
from ..dependencies import get_db_connection, get_redis, get_current_user
...
class APIKeyCreateRequest(BaseModel):
    ...
    allowed_ips: Optional[List[str]] = Field(None, max_items=100)
...
async def revoke_api_key(
    ...
    ownership_result = await api_key_manager.verify_key_ownership(key_id, current_user.client_id)
