...
from src.pd_prime_demo.models.quote import (
    ...
    QuoteBase, Quote, QuoteCreate, QuoteUpdate, QuoteComparison,
    QuoteConversionRequest, QuoteOverrideRequest, QuoteStatus
)
from src.pd_prime_demo.models.admin import (
    AdminRoleModel, AdminUser, AdminUserCreate, AdminUserUpdate,
    SystemSetting, AdminActivityLog, AdminDashboard, Permission
)
...
def audit_frozen_compliance():
    ...
    models_to_check = [
        VehicleInfo, DriverInfo, CoverageSelection, Discount, 
        QuoteBase, Quote, QuoteCreate, QuoteUpdate, QuoteComparison,
        QuoteConversionRequest, QuoteOverrideRequest,
        AdminRoleModel, AdminUser, AdminUserCreate, AdminUserUpdate,
        SystemSetting, AdminActivityLog, AdminDashboard
    ]
...
def audit_validation_coverage():
    ...
    try:
        ...
        validation_tests.append('❌ VehicleInfo: VIN validation failed (accepted invalid VIN)')
    except Exception:
    ...
    try:
        ...
        validation_tests.append('❌ DriverInfo: Age validation failed (accepted underage driver)')
    except Exception:
    ...
    try:
        ...
        validation_tests.append('❌ AdminUserCreate: Password validation failed (accepted weak password)')
    except Exception:
...
def audit_immutability():
    ...
    try:
        ...
        try:
            ...
            immutability_tests.append('❌ VehicleInfo: Immutability failed (field was modified)')
        except Exception:
            immutability_tests.append('✅ VehicleInfo: Immutability enforced')
            
    except Exception as e:
        immutability_tests.append(f'❌ VehicleInfo: Could not create for immutability test: {e}')
    ...
    try:
        ...
        try:
            ...
            immutability_tests.append('❌ AdminRoleModel: Immutability failed (field was modified)')
        except Exception:
            immutability_tests.append('✅ AdminRoleModel: Immutability enforced')
            
    except Exception as e:
        immutability_tests.append(f'❌ AdminRoleModel: Could not create for immutability test: {e}')
