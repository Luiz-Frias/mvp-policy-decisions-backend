...
def test_all_providers():
    ...
    providers_config = [
        ("Google", "pd_prime_demo.core.auth.providers.google", "GoogleSSOProvider", {
            "client_id": "test-id",
            "client_secret": "test-secret", 
            "redirect_uri": "http://localhost:8000/callback"
        }),
        ("Azure AD", "pd_prime_demo.core.auth.providers.azure", "AzureADSSOProvider", {
            "client_id": "test-id",
            "client_secret": "test-secret",
            "redirect_uri": "http://localhost:8000/callback",
            "tenant_id": "test-tenant"
        }),
        ("Okta", "pd_prime_demo.core.auth.providers.okta", "OktaSSOProvider", {
            "client_id": "test-id", 
            "client_secret": "test-secret",
            "redirect_uri": "http://localhost:8000/callback",
            "okta_domain": "dev-12345.okta.com"
        }),
        ("Auth0", "pd_prime_demo.core.auth.providers.auth0", "Auth0SSOProvider", {
            "client_id": "test-id",
            "client_secret": "test-secret", 
            "redirect_uri": "http://localhost:8000/callback",
