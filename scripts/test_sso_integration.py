...
async def test_sso_integration() -> None:
    ...
    try:
        ...
        print(f"✅ SSO Manager initialized successfully")
        ...
        if "google" in providers:
            ...
            if google_provider:
                ...
                if isinstance(auth_url_result, Ok):
                    ...
                    print(f"❌ Authorization URL generation failed: {auth_url_result.error}")
                ...
                if isinstance(user_result, Ok):
                    ...
                    print(f"✅ User provisioned successfully: {user.email} (Role: {user.role})")
